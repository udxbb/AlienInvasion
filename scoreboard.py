...
class Scoreboard():
    ...
    def prep_level(self):
        ...
        self.current_level_image = self.font.render(current_level, True, self.text_color, self.ai_settings.bg_color)

        # 将等级放在得分下方
        self.current_level_rect = self.current_level_image.get_rect()
        self.current_level_rect.right = self.score_rect.right
